...
namespace MyBIIntegration.Integration {
	internal class InitialDataRetrievalGI {
		//Retrieving the quantities of stock items
		public static void RetrieveItemQuantities(DefaultSoapClient soapClient) {
			...
			ItemAvailabilityDataInquiry results = (ItemAvailabilityDataInquiry)soapClient.Put(inqParameters);

			//Save results to a CSV file
			using (StreamWriter file = new StreamWriter("ItemAvailabilityData.csv")) {
				//Add headers to the file
				file.WriteLine("InventoryID;Description;Warehouse;QtyAvailable;QtyOnHand;");
